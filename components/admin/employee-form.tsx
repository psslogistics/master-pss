...
export function EmployeeForm({ roles, employee, onSubmit, onCancel }: { roles: Role[]; employee?: Employee; onSubmit(draft: EmployeeDraft): string | undefined | Promise<string | undefined>; onCancel(): void }) {
  ...
  async function submit(event: FormEvent) {
    ...
    const message = await onSubmit(draft); if (message) setError(message);
  }
