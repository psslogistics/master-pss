...
export const demoRoles: Role[] = [
  ...
  { id: "role-crm", name: "Client Relationship Manager", description: "Client ownership and support coordination.", department: "Client Success", color: "violet", permissionKeys: ["dashboard.view", "clients.view", "clients.create", "clients.edit", "crm.view", "crm.manage", "tickets.view", "tickets.reply", "tickets.close", "reports.view"] },
